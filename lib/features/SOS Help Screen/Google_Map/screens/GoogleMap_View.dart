...
import 'package:Rakshak/utils/constants/colors.dart';
      ...
      floatingActionButton: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: TColors.sosRed.withOpacity(0.3),
                blurRadius: 20,
                spreadRadius: 5,
              ),
            ],
          ...
          child: FloatingActionButton.extended(
            label: Text(
              sosController.isSOSActive.value ? "Stop SOS" : "Start SOS",
              style: TextStyle(
                color: Colors.white,
            ...
            backgroundColor: TColors.sosRed,
            onPressed: () async {
              print("printing");
